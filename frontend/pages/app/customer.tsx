...
export default function CustomerPage() {
  ...
  return (
    <DashboardLayout profile={profile} title="Customer Analytics">
      <div className="p-6 max-w-3xl mx-auto">
        <div className="card p-12 text-center mt-10">
          ...
          <h2 className="font-display text-2xl font-800 text-ink-900 mb-3">Customer Analytics</h2>
          <p className="text-ink-500 text-sm leading-relaxed max-w-md mx-auto mb-8">
            ARR bridge, NRR/GRR, top movers, retention trends and vintage analysis. This module is currently in development.
          </p>
